...
import '../buyer/order_tracking_screen.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () =>
                context.read<NotificationProvider>().markAllAsRead(widget.userId),
            child: const Text(
              'Tandai Semua Dibaca',
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                color: notif.isRead ? null : Theme.of(context).colorScheme.primary.withOpacity(0.06),
                child: ListTile(
